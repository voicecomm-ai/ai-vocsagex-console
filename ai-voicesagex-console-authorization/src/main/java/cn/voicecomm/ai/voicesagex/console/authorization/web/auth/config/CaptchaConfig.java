...
public class CaptchaConfig {
  ...
  public DefaultKaptcha getKaptchaBean() {
    ...
    properties.setProperty(
      Constants.KAPTCHA_OBSCURIFICATOR_IMPL, "com.google.code.kaptcha.impl.WaterRipple");
  ...
  public DefaultKaptcha getKaptchaBeanMath() {
    ...
    properties.setProperty(Constants.KAPTCHA_BORDER, "yes");
    // 边框颜色 默认为Color.BLACK
    properties.setProperty(Constants.KAPTCHA_BORDER_COLOR, "153,153,153");
    // 验证码文本字符颜色 默认为Color.BLACK
    ...
    // 验证码文本生成器
    properties.setProperty(
      Constants.KAPTCHA_TEXTPRODUCER_IMPL,
      "cn.voicecomm.ai.voicesagex.console.authorization.web.auth.util.CaptchaTextCreatorUtil");
    // 验证码文本字符间距 默认为2
