...
@NoArgsConstructor
@SuperBuilder
public class ModelCategoryDto extends BaseAuditDto {

  @Serial
  private static final long serialVersionUID = -7817449183169639720L;
   ...
   * 模型名称
   */
  @NotBlank(message = "模型分类名称不能为空", groups = {AddGroup.class, UpdateGroup.class})
